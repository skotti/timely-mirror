...
) -> Vec<u64>
{
    ...
    // Write data 1
    for i in 0..CACHE_LINE_SIZE as usize {
        cache_line_1[i] = data[i as usize];
    }
    ...
    // Write data 2
    for i in 0..CACHE_LINE_SIZE as usize {
        cache_line_1[i] = data[i + CACHE_LINE_SIZE as usize];
    }
    dmb();

    for i in 0..CACHE_LINE_SIZE as usize {
        output_arr[i + CACHE_LINE_SIZE as usize] = cache_line_2[i];
    }
    dmb();
